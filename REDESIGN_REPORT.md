...
- Галерея проверяет дополнительные изображения поставщика при загрузке и убирает недоступные миниатюры из списка и счётчика; при отсутствии всех фото показывает аккуратное сообщение.
